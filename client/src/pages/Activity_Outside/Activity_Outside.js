...
import "./activity_outside.css";
import Loader from "../../components/Loader";

const Activity_Outside = () => {
  ...
  const handleSearchSubmit = () => {
    ...
    const url = `http://${hostName}/student_outside_check_activity/?${queryParams}`;
  ...
  const handleExportOutsideToExcel = async () => {
    if (!activityYearExcel) {
      ...
      try {
        const response = await fetch(
          `http://${hostName}/export-outside-to-excel?activityYearExcel=${activityYearExcel}`
        );
        if (response.ok) {
            ...
            <div className="col-md-4">
              <div className="sidebar">
                ...
                >
                  <li
                    className={
                      location.pathname === "/activity_outside" ? "active" : ""
                    }
                  >
                    <Link
                      to={`/activity_outside?q=${encodeURIComponent(
                        ciphertext
                      )}`}
                    >
                      ตรวจสอบกิจกรรมนักศึกษา{" "}
                      {countInside.outsideNumber !== 0 && (
                        <span style={{ color: "red", fontWeight: "bold" }}>
                          ({countInside.outsideNumber})
                        </span>
                      )}
                    </Link>
                  </li>
        ...
        {showExportModal && (
          ...
          >
            ...
            <Modal.Footer>
              <Button
                className="btn btn-success"
                onClick={() => handleExportOutsideToExcel()}
              >
                พิมพ์รายงาน
              </Button>
              <Button
          ...
          >
            ...
            <Modal.Body>
              ...
              >
                ...
                <p>
                  <strong>ชื่อกิจกรรม:</strong> {selectedStudent.activity_name}
                </p>
                <p>
                ...
                <p>
                  <strong>กรุณาเลือกกลุ่มเป้าหมายของกิจกรรม:</strong>{" "}
                  {selectedStudent.activity_target}
                </p>
                <p>
...
export default Activity_Outside;
