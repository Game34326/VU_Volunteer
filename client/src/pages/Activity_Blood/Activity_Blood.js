...
import "./activity_blood.css";
import Loader from "../../components/Loader";

const Activity_Blood = () => {
  ...
  const handleSearchSubmit = () => {
    ...
    const url = `http://${hostName}/student_blood_check_activity/?${queryParams}`;
  ...
  const handleExportBloodToExcel = async () => {
    if (!activityYearExcel) {
      ...
      try {
        const response = await fetch(
          `http://${hostName}/export-blood-to-excel?activityYearExcel=${activityYearExcel}`
        );
        if (response.ok) {
          ...
          a.href = url;
          a.download = "กิจกรรมบริจาคโลหิต.xlsx";
      ...
      <div>
            ...
            <div className="col-md-4">
              <div className="sidebar">
                ...
                >
                  <li
                    className={
                      location.pathname === "/activity_blood" ? "active" : ""
                    }
                  >
                    <Link
                      to={`/activity_blood?q=${encodeURIComponent(ciphertext)}`}
                    >
                      ตรวจสอบกิจกรรมนักศึกษา{" "}
                      {countInside.bloodNumber !== 0 && (
                        <span style={{ color: "red", fontWeight: "bold" }}>
                          ({countInside.bloodNumber})
                        </span>
                      )}
                    </Link>
                  </li>
              ...
              <tbody>
                {studentForm.map((student, index) => (
                  <tr key={student.student_id}>
                    ...
                    <td>{student.activity_position}</td>
                    <td>
        ...
        {showExportModal && (
          ...
          >
            ...
            >
              พิมพ์รายงานกิจกรรมการบริจาคโลหิต
            </Modal.Title>
            <hr />
            <Modal.Body>
              <Form>
            ...
            <Modal.Footer>
              <Button
                className="btn btn-success"
                onClick={() => handleExportBloodToExcel()}
              >
                พิมพ์รายงาน
              </Button>
              <Button
          ...
          >
            ...
            <Modal.Body>
              ...
              >
                ...
                <p>
                  <strong>วันที่บริจาคโลหิต:</strong>{" "}
                ...
                <p>
                  <strong>สถานที่บริจาคโลหิต:</strong>{" "}
                  {selectedStudent.activity_place}
                </p>
                <p>
                ...
                <p>
                  <strong>จัดขึ้นโดยหน่วยงาน:</strong>{" "}
